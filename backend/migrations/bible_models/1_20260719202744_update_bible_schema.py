...
async def upgrade(db: BaseDBAsyncClient) -> str:
    ...
    "book_id" INT NOT NULL REFERENCES "bible_content" ("id") ON DELETE CASCADE
);"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        DROP TABLE IF EXISTS "dailyverse";"""
...
MODELS_STATE = (
    ...
    "Qu21iOEI7aivX0WLMkULm0CxWQvMuJQ44iPM9WHG1VfCMgXTCU2/qx/LeQwNvgeni7yJEf"
    "U+Mm8v2uetS7Nx/itxhXHUMFtipJ64vlDStb3UlzKapPanbZ7UxGPtpttpSYKYsj6Rb4z1"
    "zBvRIBWdJWwh/GgBR/MxJVVgprtZhU6FZlH19SOGi+1FlzIobaR60ZqjJBrRzcZls3HUmt"
    "eGXnx4e/kHB9/acA=="
)

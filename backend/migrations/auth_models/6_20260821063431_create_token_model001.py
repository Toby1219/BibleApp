...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "usertoken" RENAME COLUMN "acess_token" TO "access_token";"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "usertoken" RENAME COLUMN "access_token" TO "acess_token";"""
...
MODELS_STATE = (
    ...
    "vkN5cYgb+g4l0M51EjBW1zvoPxH7ttqvSStqnfaDloU4B/GjzeI10X0F33zcSRSi69Td5I"
    "uZEXZRuflsNvzyKiPuroz5b5F7qoI3vjJGOcHA0FLqOWd/+oXAFv8P4b+V/EpWldrydCrq"
    "iJXp58F+wMJ0K45bcdwgcfyMwm2IGLacStUWNj8u2WDi2Oq1Jk3yOr12ixgP6+a7fjaQCj"
    "kJmXCEzwXUzNqDcOh+gnR7O32z36v5Zr9X8s1+UhrIEv79xphXFJqTkHyVGVui80/HxbyJ"
    "mqAGroJRL3nz6vZ1tkasLjAq0wzH3Nse/gWC7CLp"
)
